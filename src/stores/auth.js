...
export const useAuthStore = defineStore('auth', {
    ...
    actions: {
        ...
        getAllUsers() {
            axios.get("https://walkspring-cuh1.onrender.com/api/auth/allUsers")
                .then(response => {
                    const data = response.data;
                    console.log("Empfangene Daten:", data); // Debugging
        ...
        deleteUser(userId) {
            ...
            axios.delete(`https://walkspring-cuh1.onrender.com/api/auth/deleteUser/${userId}`)
                .then(response => {
        ...
        editUser(id, updatedUser) {
            ...
            axios.put(`https://walkspring-cuh1.onrender.com/api/auth/editUser/${id}`, updatedUser, {
                headers: {
